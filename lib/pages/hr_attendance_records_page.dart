...
class _HrAttendanceRecordsPageState extends State<HrAttendanceRecordsPage> {
  ...
  Widget build(BuildContext context) {
    final checkIns   = AttendanceStore.checkIns.where((r) => _matches(r.employee)).toList();
    final checkOuts  = AttendanceStore.checkOuts.where((r) => _matches(r.employee)).toList();
    final lateComing = AttendanceStore.lateComing.where((r) => _matches(r.employee)).toList();
