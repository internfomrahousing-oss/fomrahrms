...
class _StaffPermissionPageState extends State<StaffPermissionPage> {
  ...
  Future<void> _submit() async {
    ...
    if (_date == null) {
      _snack('Please select a permission date.');
      return;
    }
    ...
    return SingleChildScrollView(
      ...
      child: Column(children: [
        ...
        if (_limitReached)
          Container(
            ...
            child: Row(children: [
              ...
              const Expanded(
                child: Text('You have already used your maximum 2 permissions for this month.',
                    style: TextStyle(fontSize: 13.5, fontWeight: FontWeight.w600, color: Color(0xFF9A3412))),
              ),
            ]),
          ),
        ...
        Align(
          ...
          child: Text('Permission Duration',
