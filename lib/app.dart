  ...
  routes: [
    ...
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(path: '/hr/my-attendance',          builder: (_, __) => const EmployeeAttendancePage(prefix: '')),
    ...
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(path: '/manager/my-attendance',           builder: (_, __) => const EmployeeAttendancePage(prefix: '/manager')),
    ...
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(path: '/management/leave/overview',         builder: (_, __) => const LeaveManagementPage()),
        ...
        GoRoute(path: '/management/leave/team-approvals',   builder: (_, __) => const TeamLeaveApprovalsPage(isManagement: true)),
