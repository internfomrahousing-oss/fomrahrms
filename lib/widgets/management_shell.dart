...
const _navItems = [
  ...
  _NavItem('Performance Management', Icons.trending_up_rounded,            '/management/performance-management'),
  ...
  _NavItem('Edit Application Form',  Icons.edit_document,                  '/management/edit-form'),
